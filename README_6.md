...
[![Station: Ordnance](https://img.shields.io/badge/Station-Ordnance-bf3989?style=flat-square)](#ordnance-officer)
...
| Ordnance Officer | Athletics | Ordnance Deck |
...
The Captain runs the **Standing Orders** deck - a hand of tactical order cards drawn each round - and manages the ship's shields and damage control.

### Initiative

Click the d20 icon to roll ship initiative for the combat tracker: `1d20 + Persuasion modifier`. The result is stored directly in the combat tracker. Points allocated to the Initiative track add +1 per Point at the next round transition; the previous Ship Combat bonus is removed before the new bonus is applied.
...
Each dispatched Power Core generates flux the following round, which the Captain allocates across the four shield sectors.
...
The Ordnance Officer manages crew logistics, ordnance deployment, and supply delivery to other stations.

### Ordnance Allocation

Roll Athletics once per round. Allocate Points to:
...
|--------|----------|----------|
| Gunner | AP Shells (+2 AP on macro cannons) | Shield-Flensing Shot (+1 shield burn per shot) |
| Pilot | Helm Burn Injector (+50% base speed) | Maneuvering Thrusters (+50% base maneuverability) |
| Sensors Officer | Telemetry Buoy (−20% AP costs, rounded up) | Lock Stabilizer (freeze all lock decay timers) |
| Engineer | Emergency Coolant (reduce heat by 3) | Aux Capacitors (+1 core output this round) |
| Captain | Cogitator Data-Slate (draw 2 extra orders, +2 hand size) | Fire Suppression Canisters (step one active condition down) |
