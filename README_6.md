...
Click the d20 icon to roll ship initiative for the combat tracker: `1d20 + Persuasion modifier`. The result is stored directly in the combat tracker. Points allocated to the Initiative track boost the result by +1 per Point for that round only.
...
23-card deck shuffled at the start of combat. Draw 3 cards per round (modified by Inspire Points). Hand cap is 6 (modified by Inspire Points for that round). Cards fall into four categories:
